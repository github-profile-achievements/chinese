...
| | 16 颗星 | 128 颗星 | 512 颗星 | 4096 颗星 <br>[@torvalds](https://github.com/torvalds?achievement=starstruck&tab=achievements) |
...
| | 1 个合并请求 <br>[@gomzyakov](https://github.com/gomzyakov?achievement=pair-extraordinaire&tab=achievements) | 10 个合并请求 | 24 个合并请求  | 48 个合并请求 <br>[@Rongronggg9](https://github.com/Rongronggg9?achievement=pair-extraordinaire&tab=achievements) |
...
| | 2 个合并请求 | 16 个合并请求 | 128 个合并请求 | 1024 个合并请求 <br>[@ljharb](https://github.com/ljharb?achievement=pull-shark&tab=achievements) |
...
| | 2 个回答 | 8 个回答 | 16 个回答 | 32 个回答 <br>[@ljharb](https://github.com/ljharb?achievement=galaxy-brain&tab=achievements) |
...
| ![Light badge GitHub Campus Expert][gce-dark]![Dark badge GitHub Campus Expert][gce-light] | **GitHub Campus Expert** | 否 | 参与 [GitHub Campus Program](https://education.github.com/experts) *(2024.2.29前有效)* |
| ![Dark badge Security advisory credit][SAC-dark]![Light badge Security advisory credit][SAC-light] | **Security advisory credit** | 是 | 提交到 [GitHub Advisory Database](https://github.com/advisories) 的安全性建议被接受 |
...
如果您对如何改进此页面上的信息有疑问或建议，您可以随时写信给 [issues](https://github.com/github-profile-achievements/chinese/issues)。
